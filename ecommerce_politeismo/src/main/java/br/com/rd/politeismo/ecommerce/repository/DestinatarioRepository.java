 ...
 * br.com.rd.politeismo.ecommerce.orm.Destinatario;
 * 
 * 
 * @Repository public interface DestinatarioRepository extends
 * JpaRepository<Destinatario, Long>, CrudRepository<Destinatario, Long> {
 * 
