 ...
 * br.com.rd.politeismo.ecommerce.orm.Remetente;
 * 
 * 
 * @Repository public interface RemetenteRepository extends
 * JpaRepository<Remetente, Long>, CrudRepository<Remetente, Long> {
 * 
