 ...
 * br.com.rd.politeismo.ecommerce.orm.Endereco;
 * 
 * 
 * @Repository public interface EnderecoRepository extends
 * JpaRepository<Endereco, Long>, CrudRepository<Endereco, Long> {
 * 
