...
public class Entrega {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id_entrega, id_forma_entrega, prazo_estimado_entrega, valor_entrega);
	}
	@Override
	public String toString() {
		return "Entrega [id_entrega=" + id_entrega + ", id_forma_entrega=" + id_forma_entrega
				+ ", prazo_estimado_entrega=" + prazo_estimado_entrega + ", valor_entrega=" + valor_entrega + "]";
	}
