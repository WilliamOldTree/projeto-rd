...
const ResumoFavoritos = (props) => {
    return <>
        <tr className="tr_listCompra">
            ...
            <th className='col-3 col-sm-3 col-xs-3 area-favoritos' onClick={() => addToCart(produtosFavoritos)}>
            <Link to={'/cart'} className='linkproduct'> <a className='btn btn-detalhes' href='#' role='button'>COMPRAR</a> </Link>
