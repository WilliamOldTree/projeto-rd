...
//		if (razaoBack != null && cnpjBack !=null && emailBack !=null) {
//			if (!razaoBack.equals("")){
//				Fornecedor fc1 = new Fornecedor(razaoBack, cnpjBack, emailBack);
//				this.fc.insert(fc1);
//			}
//		}
...
//		String idBack = request.getParameter("id");
//		if ((razaoBack != null) && (idBack != null) && (cnpjBack != null) && (emailBack != null)) {
//			if (!razaoBack.equals("")){
//				Integer id = Integer.parseInt(idBack);
//				Fornecedor fc1 = new Fornecedor(razaoBack, cnpjBack, emailBack);
//				fc1.setId(id);
