    ...
    <div class="container">
        <div class="container-form">
            ...
            <div class="form">
                ...
                <h1 class="title">Cadastro de Departamentos</h1>

	<form action="DepartamentoController" method="post">
		<c:choose>
			<c:when test="${departamento == null }">
				<label class="form-label">Departamento:</label><input style="width: 80%;" class="form-control" type="text" name="nome" required/>
			     <br>
				<button class="btn form"  type="submit" name="option" value="insert" role="button">Salvar</button>
			</c:when>
			<c:otherwise>
				<input type="hidden" name="id" value="${departamento.id}"/>
				<label class="form-label">Departamento:</label><input style="width: 80%;" class="form-control" type="text" name="nome" value="${departamento.nome}" required/>
			    <br>
