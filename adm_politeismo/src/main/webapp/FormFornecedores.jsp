	...
	<form action="FornecedorController" method="post">
		<c:choose>
			<c:when test="${fornecedor == null }">
				...
				<label class="form-label">Razão Social:</label><input style="" class="form-control" type="text" name="razao" required/>
<<<<<<< HEAD
				<label class="form-label">CNPJ:</label><input style="" class="form-control" type="text" name="cnpj" placeholder="Digite somente 14 caracteres" />
				<label class="form-label">Email:</label><input style="" class="form-control" type="text" name="email" />
			     <br>
				<button class="btn formbtn"  type="submit" name="option" value="insert" role="button">Salvar</button>
			</c:when>
			<c:otherwise>
				<input type="hidden" name="id" value="${fornecedor.id}"/>
				<label class="form-label">Razão Social:</label><input style="" class="form-control" type="text" name="razao"  value="${fornecedor.razao}" required/>
				<label class="form-label">CNPJ:</label><input style="" class="form-control" type="text" name="cnpj"  value="${fornecedor.cnpj}" placeholder="Digite somente 14 caracteres"/>
				<label class="form-label">Email:</label><input style="" class="form-control" type="text" name="email"  value="${fornecedor.email}" />
			    <br>
				<button class="btn formbtn" type="submit" name="option" value="update">Atualizar</button>
			</c:otherwise>
=======
				<label class="form-label">CNPJ:</label><input style="" class="form-control" type="text" name="cnpj"   required maxlength="18" id="ipt-cnpj" />
				<label class="form-label">Email:</label><input style="" class="form-control" type="text" name="email"  required/>
			     <br>
			     
<button class="btn formbtn" type="button"  data-bs-toggle="modal" data-bs-target="#modal-delete-${fornecedor.id}"  style="margin-right: 10px;">Salvar                   
                                      </button>	 	
										...
										<div class="modal-dialog ">
											<div class="modal-content ">
												...
												<div class="text-center px-3 py-3">
													<p class=" text-success"> Fornecedor cadastrado com sucesso!.</p>
												</div>
			...
			<c:otherwise>
				<input type="hidden" name="id" value="${fornecedor.id}"/>
				<label class="form-label">Razão Social:</label><input style="" class="form-control" type="text" name="razao"  value="${fornecedor.razao}" required/>
				<label class="form-label">CNPJ:</label><input style="" class="form-control" type="text" name="cnpj"  required maxlength="18"  value="${fornecedor.cnpj}" id="ipt-cnpj" required/>
				<label class="form-label">Email:</label><input style="" class="form-control" type="text" name="email"  value="${fornecedor.email}" required />
			    <br>
<button class="btn formbtn" type="button"  data-bs-toggle="modal" data-bs-target="#modal-delete-${fornecedor.id}"  style="margin-right: 10px;">Salvar                   
                                      </button>	 	
                                      	<div class="modal fade" id="modal-delete-${fornecedor.id }" tabindex="-1" aria-labelledby="inicioModal" aria-hidden="true">
