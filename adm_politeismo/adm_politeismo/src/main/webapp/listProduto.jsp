                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="container">
                                ...
                                <div class=menu-list1>
                                    ...
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="formFornecedor.jsp">Cadastro Fornecedores
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="lisDepartamento.jsp">Lista Departamentos
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listCategoria.jsp">Lista Categorias
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listProduo.jsp">Lista Produtos
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listFornecedor.jsp">Lista Fornecedores
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listCliente.jsp">Lista Clientes
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listPedidos.jsp">Lista Pedidos
                                        <hr width="160">
                                    </a>
                                </div>
                            </div>
