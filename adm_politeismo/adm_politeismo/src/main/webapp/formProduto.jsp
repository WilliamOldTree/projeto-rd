                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                            ...
                            <div class="container">
                                ...
                                <div class=menu-list1>
                                    ...
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listFornecedor">Lista Fornecedores
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listCliente.jsp">Lista Clientes
                                        <hr width="160">
                                    </a>
                                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="listPedido">Lista Pedidos
                                        <hr width="160">
                                    </a>
                                </div>
                            </div>
	...
	<form action="ProdutoController" method="post">
		<c:choose>
			...
			<c:otherwise>
				...
				<label class="form-label">Produto:</label><input style="width: 80%;" class="form-control" type="text" name="nome" value="${produto.nome}" required/>
			    <br>
