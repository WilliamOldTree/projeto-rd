...
PRIMARY KEY								(ID_BOLETO, FK_ID_FORMA),
...
FK_ID_FORMA								INT										NOT NULL,
FK_ID_CLIENTE							INT 									NOT NULL,
PRIMARY KEY								(ID_PIX, FK_ID_FORMA),
FOREIGN KEY								(FK_ID_FORMA)							REFERENCES 		FORMA		(ID_FORMA),
FOREIGN KEY								(FK_ID_CLIENTE)							REFERENCES 		CLIENTE 	(ID_CLIENTE)
);
...
FK_ID_FORMA 							INT										NOT NULL, 
FK_ID_CLIENTE 							INT										NOT NULL,
PRIMARY KEY								(ID_NUMERO_CARTAO, FK_ID_FORMA),
FOREIGN KEY								(FK_ID_FORMA)							REFERENCES		FORMA 		(ID_FORMA),
FOREIGN KEY								(FK_ID_CLIENTE)							REFERENCES 		CLIENTE 	(ID_CLIENTE) 
);
...
FK_ID_FORMA_ENTREGA						INT										NOT NULL, 
FK_ID_STATUS_ENTREGA					INT										NOT NULL,
PRIMARY KEY								(ID_ENTREGA),
FOREIGN KEY								(FK_ID_FORMA_ENTREGA)					REFERENCES 		FORMA_ENTREGA 		(ID_FORMA_ENTREGA),
FOREIGN KEY								(FK_ID_STATUS_ENTREGA)					REFERENCES		STATUS_ENTREGA		(ID_STATUS_ENTREGA)
);
