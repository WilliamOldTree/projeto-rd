...
insert into PRODUTO (DESCRICAO, ESTOQUE, PESO, PRECO, VOLUME, FK_ID_CATEGORIA, FK_ID_DEPARTAMENTO, FK_ID_FORNECEDOR, FK_ID_PRODUTO_DESTAQUE, FL_INATIVO)
values ('Buda Dourado', 295, '0.2', '23.50', '1.0', 13, 5, 3, 1, 1);